...
- **NEXT: /release-readiness 0.5.0 verdict + fixes, then ASK owner re 0.5.0 tag** (bump-version skill; expect version-staging gate to flag the unstaged bump — that's the owner-gated step, not a blocker).

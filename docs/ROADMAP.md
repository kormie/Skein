...
- [#267](https://github.com/kormie/Skein/issues/267) — **GA blocker (freeze-sensitive):** unify all effects under one `with_overrides`/`with_dependencies` test-override API (the #261 nondeterminism work seeds it; today the test-injection seam is per-effect).
